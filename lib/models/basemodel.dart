...
class BaseModel extends BaseViewModel {
  ...
  Future<void> getTemperature() async {
    ...
    try {
      ...
      print('Error loading temperature: $error');
    }
  }
  ...
  Future<void> fetchHourlyWeather() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to fetch hourly weather data. Status code: ${response.statusCode}');
      }
    } catch (error) {
  ...
  Future<void> fetchWeeklyWeather() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to fetch weekly weather data. Status code: ${response.statusCode}');
      }
    } catch (error) {
